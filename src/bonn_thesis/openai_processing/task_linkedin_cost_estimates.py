"""Pytask for estimating costs of LinkedIn OpenAI batch processing."""
...
def task_estimate_costs_wage_linkedin_exp(
    depends_on=dependencies,
    produces=LINKEDIN_MATCHED_TO_SOEP_BLD / "linkedin_metadata.csv",
):
    """Estimate costs for LinkedIn OpenAI batch processing and save metadata.
